      ...
      <div className='goldLibraryDetailForm-component' style={{ overflow: 'auto', background: '#fff', position: 'fixed', zIndex: 200, left: '0', right: '0', top: '0', bottom: '0' }}>
        <div className="form-content" style={{ height: '19.8666667rem', overflow: 'auto' }}>
          <List>
            ...
            <InputItem {...getFieldProps('applyName')} clear placeholder="">PCT专利申请人:</InputItem>
            <InputItem {...getFieldProps('applyTel')} clear placeholder="">申请人电话:</InputItem>
            <InputItem {...getFieldProps('applyEmail')} clear placeholder="">申请人邮箱:</InputItem>
